...
def initExp(initExp_args_dict, assert_200=True, url="http://"+HOSTNAME):
    url2 = url + "/api/experiment"
    response = requests.post(url2, json.dumps(initExp_args_dict),
    ...
    # Test initExperiment
    #################################################
    url2 = url + "/api/experiment/"+exp_uid
